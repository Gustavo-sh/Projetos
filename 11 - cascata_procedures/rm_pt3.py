...
try:
    with pyodbc.connect(CONNECTION_STRING, autocommit = True) as conn:
        ...
        write_log(
            f"Executando Robbyson Matriz parte 3 (SPID: {spid})..."
        )

        cursor.execute("EXEC dbo.sp_ins_Robbyson_Matriz_pt3")
        ...
        write_log(
            f"Procedure Robbyson Matriz parte 3 finalizada (SPID: {spid})..."
        )
